...
# MADE BY MAMBA NETWORK
# MADE FOR HIDDENMAMBA
# FULL CREDITS MAMBA NETWORK🔥🔥🔥
...
from HIDDENMAMBA.events import register
...
import heroku3
from HIDDENMAMBA import OWNER_ID, telethn as update


UPSTREAM_REPO_URL = "https://github.com/SUKHPAL443/HIDDENMAMBA"
...
async def upstream(ups):
    ...
    if HEROKU_API_KEY is not None:
        ...
        await lol.edit("`Successfully Updated!\n" "restarting......`")
        args = [sys.executable, "-m", "HIDDENMAMBA"]
