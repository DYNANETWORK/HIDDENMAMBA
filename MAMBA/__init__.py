...
try:
  from SUKHPAL443 import ID
except:
   os.system("pip install SUKHPAL443")
   from SUKHPAL443 import ID
StartTime = time.time()
# enable logging
logging.basicConfig(
...
if ENV:
    ...
    from HIDDENMAMBA.config import Development as Config
...
pbot = Client("HIDDENMAMBA", api_id=API_ID, api_hash=API_HASH, bot_token=TOKEN)
...
#WRITTEN BY MAMBA STAR
from HIDDENMAMBA.modules.helper_funcs.handlers import (
