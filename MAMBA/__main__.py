...
from HIDDENMAMBA.modules import ALL_MODULES
from HIDDENMAMBA.modules.helper_funcs.alternate import typing_action
from HIDDENMAMBA.modules.helper_funcs.chat_status import is_user_admin
from HIDDENMAMBA.modules.helper_funcs.misc import paginate_modules
from HIDDENMAMBA.modules.helper_funcs.readable_time import get_readable_time

PM_START_TEXT = """
Hello there, I'm [HIDDEN MAMBA](https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg)
...
buttons = [
    ...
    [
        InlineKeyboardButton(
            text="💫 Add HIDDEN MAMBA to your group 💫",
            url="t.me/MAMBA_STAR?startgroup=true",
        ),
    ],
]
...
HELP_STRINGS = f"""
*Main Commands :* [HIDDEN MAMBA](https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg)
...
Support them  [N](t.me/MAMBA_X_SUPPORT,[HIDDEN MAMBA](t.me/MAMBA_X_SUPPORT),"""
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("HIDDENMAMBA.modules." + module_name)
...
@run_async
def HIDDENMAMBA_about_callback(update, context):
    query = update.callback_query
    if query.data == "aboutmanu_":
        query.message.edit_text(
            text=f"*😍 Hi again!  The name's {dispatcher.bot.first_name} 😍 \n\nAs  You I'm a next generational group management bot developed by @MAMBA_STAR.* "
            f"\n\n 🔥 Join [BLACK_MAMBA](https://t.me/MAMBA_X_SUPPORT) To Keep Yourself Updated About {dispatcher.bot.first_name} 🔥"
            f"\n\n I have the normal GROUP MANAGING functions like flood control, a warning system etc but I mainly have the advanced and handy Antispam system and the SIBYL banning system which safegaurds and helps your group from spammers."
            f"\n\nI Can Manage Your Groups Smoothly, With Some Special Features [:)](https://telegra.ph/file/ea68644f59bdaf57fd61e.jpg)"
        ...
        query.message.edit_text(
            ...
            f"\n\nYou Can get support {dispatcher.bot.first_name} by joining [support](https://t.me/MAMBA_X_SUPPORT).\n"
            f"",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
        ...
        query.message.edit_text(
            ...
            f"\n\nBased on [MAMBA](https://github.com/SUKHPAL443."
            f"\n\n{dispatcher.bot.first_name}'s source code was rewritten by @MAMBA_STAR and @MAMBAMUSIC_ASSISTANT"
        ...
        query.message.edit_text(
            ...
            f"\n✪ Always try to keep credits, so \n  This hardwork is done by @MAMBA_STAR spending many sleepless nights.. So, Respect it."
...
def main():
    ...
    about_callback_handler = CallbackQueryHandler(
        HIDDENMAMBA_about_callback, pattern=r"aboutmanu_"
    )
